...
class AternosAPI(StatefulBrowser):
    ...
    def StartServer(self):
        ...
        if serverstatus == "Online":
            ...
            startserver = self.open(url=f"https://aternos.org/panel/ajax/start.php?headstart=0", headers=self.headers)
            self.skip_queue()
    ...
    def queue_confirm(self):
        confirm = self.open(url=f'https://aternos.org/panel/ajax/confirm.php',headers=self.headers)
...
if __name__ == "__main__":
    api = AternosAPI(
        ...
        cookie='GAzZ83qTl5xNInA34b08JMFpv7rdaYPnxwHizvwajiMIGaVLRUc3I9wOTdTTaSsRwCeHuHUEDeDQYdlAKmI6PIgL7rwHY3vnfrsM'
        )
    api.StartServer()
